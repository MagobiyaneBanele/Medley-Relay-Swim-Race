//Banele Magobiyane
/*
// The StadiumView class extends JPanel and implements Runnable to visually represent the stadium grid and the locations of people (swimmers) in the simulation.
// It continuously updates the display by painting the grid, lanes, and individual swimmers, using the paintComponent method to draw the current state.
// Synchronization and accurate updates are crucial for reflecting the real-time positions of swimmers and the layout of the grid, ensuring a consistent and dynamic view of the simulation.
*/
